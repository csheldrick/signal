...
import type { OfflineSyncQueue as OfflineSyncQueueContract, PluginContext, PluginHost } from '../core/types.js';
import type { PresenceTracker as PresenceTrackerContract } from '../collaboration/types.js';
...
export class SignalApp {
  ...
  readonly eventsContract: LocalStorageEventBusContract;
  ...
  constructor(config: AppConfig) {
    ...
    try {
      ...
      const noop = {
        ...
        clearTrace: () => {},
        removeAllListeners: () => {},
      } as unknown as LocalStorageEventBusContract;
...
const mod = require('../indexing/index.js');
    ...
    const MAX_CONCURRENT_REMOTE_SUMMARIES = 1; // reduce remote summarizer concurrency to limit network pressure
