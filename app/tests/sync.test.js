...
describe('resolveConflict', () => {
    ...
    it('last-write-wins picks newer updatedAt', () => {
        const { winner } = resolveConflict({ documentId: 'doc-1', local: older, localClock, remote: newer, remoteClock }, 'last-write-wins');
    ...
    it('first-write-wins picks older createdAt', () => {
        ...
        const { winner } = resolveConflict({ documentId: 'doc-1', local: localFirst, localClock, remote: remoteFirst, remoteClock }, 'first-write-wins');
    ...
    it('merge-content concatenates divergent bodies and unions tags', () => {
        ...
        const { winner } = resolveConflict({ documentId: 'doc-1', local, localClock, remote, remoteClock }, 'merge-content');
    ...
    it('records a ConflictRecord with correct metadata', () => {
        const { record } = resolveConflict({ documentId: 'doc-1', local: older, localClock, remote: newer, remoteClock }, 'last-write-wins');
